...
public class ImageLoader {
    ...
    /**
     * Determine if the ImageView has been reused
     *
     * @param imageAware
     * @return
     */
    ...
    public void loadBitmap(final String url, final ImageAware imageAware) {
        ...
        //Get the key from the memory cache
        ...
        //Perform network operations (including disk cache)
